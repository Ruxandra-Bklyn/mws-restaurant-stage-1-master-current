    ...
    fetchRestaurantFromURL((error, restaurant) => {
        if (error) { // Got an error!
            ...
            L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
                mapboxToken: 'pk.eyJ1IjoiYnJvb2tseW5lbGxhIiwiYSI6ImNqa3locmVmajBqbGQzcGw3YTlydWhvd2QifQ.4i63a__bCTKzsa6RNdONqQ',
                maxZoom: 18,
...
fetchRestaurantFromURL = (callback) => {
    ...
    if (!id) { // no id found in URL
        error = 'Why do I get No restaurant id in URL error?'
        callback(error, null);
    } else {
...
/**
 * Create HTML for reviews and add it to the webpage.
 */
